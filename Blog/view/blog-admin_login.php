...
<head>
    ...
    <link href="../../AdminSchoolPanel/Dashboard/css/sb-admin-2.min.css" rel="stylesheet">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image bg-transparent">
                                <img src="../../Blog/view/assets/students.png" alt="">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="forgot-password.php">Connecter vous et administrer votre blog directement en ligne</a>
                                    </div>
                                </div>
                            </div>
                        </div>
